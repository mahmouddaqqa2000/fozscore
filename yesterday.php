...
<head>
    ...
    <title>نتائج مباريات الأمس - <?php echo htmlspecialchars($site_name); ?></title>
        ...
        <div class="content-grid">
            <div class="main-column">
                <?php if (empty($matches)): ?>
                    <div class="match-card no-matches">لا توجد مباريات مسجلة للأمس.</div>
                <?php else: ?>
